...
const defaultLayers: Layer[] = [
  { id: "ascii-1", name: "layer 1", kind: "ascii", visible: true, cells: {} },
  { id: "ascii-2", name: "layer 2", kind: "ascii", visible: true, cells: {} },
  { id: "ascii-3", name: "layer 3", kind: "ascii", visible: false, cells: {} },
  { id: "ansi-1", name: "layer 1", kind: "ansi", visible: true, cells: {} },
  { id: "ansi-2", name: "layer 2", kind: "ansi", visible: true, cells: {} },
]
...
export const useAppStore = create<AppState>()((set, get) => ({
  ...
  addLayer: (kind) => {
    ...
    const newLayer: Layer = { id, name, kind, visible: true, cells: {} }
    set((s) => ({
